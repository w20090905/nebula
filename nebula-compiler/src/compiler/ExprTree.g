...
type : ^(TYPE n=ID typebody){System.out.println("type: " + n);};
field : ^(FIELD n=ID){System.out.println("field: " + n);};

prog : ^(PROG type) {System.out.println("RET");}
