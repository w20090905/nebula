...
//		}
	...
	public final void testInsertIntoOrder_ASM() throws Exception {
		c = new SubDbConfiguration(driverclass, url, username, password);
		c.openConnection();
		...
		Class<?> clz = NebulaClassLoader.defineClass("nebula.data.db.dao.OrderDAO1", new DAODump().dump());
		@SuppressWarnings("unchecked")
		DAO<Order> odao = (DAO<Order>) clz.newInstance();
