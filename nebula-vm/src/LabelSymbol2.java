...
public class LabelSymbol2 {
    ...
    public LabelSymbol2(String name) {
	    this.name = name;
    }

    public LabelSymbol2(String name, int address) {
        this(name);
        this.address = address;
    }

    public LabelSymbol2(String name, int address, boolean forward) {
        this(name);
