				...
				<div class="widget-box">
					<div class="widget-title">
						...
						<ul class="nav nav-tabs">
				  			<li><a tabindex="-1" href="#/d/${type.name}/{{data.ID}}"><h5>${attachedType.displayName} - {{data.ID}}</h5></a></li>
	[#list attachedType.attachedBy as atby]
		[#if atby.name == type.name]
				  			<li><a tabindex="-1" href="#/d/${type.name}/{{data.ID}}/${atby.name}/" class="active">${atby.name}</a></li>
		[#else]
				  			<li><a tabindex="-1" href="#/d/${type.name}/{{data.ID}}/${atby.name}/">${atby.name}</a></li>
		[/#if]
	[/#list]
						</ul>
