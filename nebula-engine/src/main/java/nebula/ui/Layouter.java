...
public class Layouter {
	...
	public Layouter() {
		...
		cachedRenderes = CacheBuilder.newBuilder().build(new CacheLoader<Type, String>() {
			public String load(Type type) throws Exception {
				...
				if (formatType != null && definedRenderes.containsKey(String.valueOf(formatType))) {
			...
			for (Field field : type.getFields()) {
				if (field.isArray()) {
					...
					case ByVal:
						...
						Object formatType = field.getAttrs().delegate().get(Type.FormatType);
						if (formatType != null && definedRenderes.containsKey(String.valueOf(formatType))) {
