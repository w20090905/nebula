package it.trace.nebula.rest.sample.listener;
...
public class ContainerContextListener extends it.trace.nebula.rest.context.listener.ContainerContextListener {
    ...
    public void contextInitialized(ServletContextEvent event) {
        ...
        ApplicationContext context = RESTfulConventionConfigBuilder.createApplicationContext("it.trace.nebula.rest.sample.resources");
