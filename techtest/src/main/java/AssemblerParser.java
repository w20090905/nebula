// $ANTLR 3.4 D:\\Projects\\nebula\\techtest\\target\\test-classes\\assembler\\Assembler.g 2012-05-25 22:51:39
...
public class AssemblerParser extends Parser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "CHAR", "FLOAT", "FUNC", "ID", "INT", "LETTER", "NEWLINE", "REG", "STRING", "STR_CHARS", "WS", "','", "'.def'", "'.globals'", "':'", "'='", "'args'", "'locals'"
    };
